...
public class interaction extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            Intent i = new Intent(interaction.this, searchpage.class);
            startActivity(i);

            // Handle the camera action
        } else if (id == R.id.nav_gallery) {
           Intent i1=new Intent(interaction.this,givereview.class);

            startActivity(i1);

        } else if (id == R.id.nav_slideshow) {
            Intent i1=new Intent(interaction.this,view.class);

            startActivity(i1);

        }
        else if (id == R.id.nav_acc) {
            Intent i1=new Intent(interaction.this,hotel.class);

            startActivity(i1);

        }
        else if(id==R.id.nav_eat){
            Intent i1=new Intent(interaction.this,eat.class);
            startActivity(i1);
        }
    ...
    private void init_gui(){
        ...
        result=ds.route(start,day);
        String a[]=result.split("->");
        ListView res= (ListView)findViewById(R.id.etdesp1);
